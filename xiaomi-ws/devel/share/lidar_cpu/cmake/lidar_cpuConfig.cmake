...
if("TRUE" STREQUAL "TRUE")
  set(lidar_cpu_SOURCE_PREFIX /home/spencer/Documents/EECE-5698/group-project/vacuum-repo/xiaomi-ws/src/lidar_cpu)
  set(lidar_cpu_DEVEL_PREFIX /home/spencer/Documents/EECE-5698/group-project/vacuum-repo/xiaomi-ws/devel)
  ...
  set(lidar_cpu_INSTALL_PREFIX /home/spencer/Documents/EECE-5698/group-project/vacuum-repo/xiaomi-ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lidar_cpu' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lidar_cpu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/spencer/Documents/EECE-5698/group-project/vacuum-repo/xiaomi-ws/src/lidar_cpu/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${lidar_cpu_dep}_FOUND)
      find_package(${lidar_cpu_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lidar_cpu_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
